...
class ProjectService:
    ...
    async def create_project(self, workspace_id: str, owner_id: str, title: str, description: Optional[str], start_date: Optional[str], due_date: Optional[str]) -> Dict[str, Any]:
        try:
    ...
    async def update_project(self, project_id: str, fields: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        if not fields:
